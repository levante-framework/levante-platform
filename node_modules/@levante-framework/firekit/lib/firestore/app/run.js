...
class RoarRun {
    ...
    async startRun(additionalRunMetadata) {
        ...
        await (0, firestore_1.setDoc)(this.runRef, (0, util_1.removeUndefined)(runData))
            .then(() => {
    ...
    async finishRun(finishingMetaData = {}) {
        ...
        if (!this.aborted) {
            ...
            return await (0, firestore_1.updateDoc)(this.runRef, finishingData)
                .then(() => this.user.updateFirestoreTimestamp())
    ...
    async writeTrial(trialData, computedScoreCallback) {
        ...
        if (!this.aborted) {
            ...
            return (0, firestore_1.setDoc)(trialRef, {
                    ...
                    if (subtask in this.scores.raw) {
                        ...
                        if (subtask !== defaultSubtask) {
                            ...
                            scoreUpdate = {
                                ...
                                [`scores.raw.${defaultSubtask}.${stage}.numCorrect`]: trialData.correct ? (0, firestore_1.increment)(1) : undefined,
