...
function createCoreError(code3) {
  return createCompileError(code3, null, process.env.NODE_ENV !== "production" ? { messages: errorMessages2 } : void 0);
}
var errorMessages2 = {
...
function translate(context, ...args) {
  ...
  if (process.env.NODE_ENV !== "production" && isString(format4) && context.messageCompiler == null) {
...
function createI18nError(code3, ...args) {
  return createCompileError(code3, null, process.env.NODE_ENV !== "production" ? { messages: errorMessages3, args } : void 0);
}
var errorMessages3 = {
    ...
    if (!key.includes(".")) {
      ...
      for (let i = 0; i < lastIndex; i++) {
        ...
        if (!isObject(currentObj[subKeys[i]])) {
          process.env.NODE_ENV !== "production" && warn(getWarnMessage2(I18nWarnCodes.IGNORE_OBJ_FLATTEN, {
            key: subKeys[i]
          }));
          hasStringValue = true;
          break;
...
function createVueI18n(options = {}, VueI18nLegacy) {
  {
    ...
    const vueI18n = {
      ...
      // formatter
      get formatter() {
        process.env.NODE_ENV !== "production" && warn(getWarnMessage2(I18nWarnCodes.NOT_SUPPORTED_FORMATTER));
        return {
          interpolate() {
            return [];
          }
      ...
      get preserveDirectiveContent() {
        process.env.NODE_ENV !== "production" && warn(getWarnMessage2(I18nWarnCodes.NOT_SUPPORTED_PRESERVE_DIRECTIVE));
        return true;
      },
      ...
      getChoiceIndex(choice, choicesLength) {
        process.env.NODE_ENV !== "production" && warn(getWarnMessage2(I18nWarnCodes.NOT_SUPPORTED_GET_CHOICE_INDEX));
        return -1;
      }
    };
...
function defineMixin(vuei18n, composer, i18n) {
  return {
    ...
    mounted() {
      if ((process.env.NODE_ENV !== "production" || __VUE_PROD_DEVTOOLS__) && true && this.$el && this.$i18n) {
        const _vueI18n = this.$i18n;
    ...
    unmounted() {
      ...
      const _vueI18n = this.$i18n;
      if ((process.env.NODE_ENV !== "production" || __VUE_PROD_DEVTOOLS__) && true && this.$el && this.$el.__VUE_I18N__) {
        if (this.__v_emitter) {
...
function setupLifeCycle(i18n, target, composer) {
  ...
  {
    onMounted(() => {
      if ((process.env.NODE_ENV !== "production" || __VUE_PROD_DEVTOOLS__) && true && target.vnode.el) {
    ...
    onUnmounted(() => {
      const _composer = composer;
      if ((process.env.NODE_ENV !== "production" || __VUE_PROD_DEVTOOLS__) && true && target.vnode.el && target.vnode.el.__VUE_I18N__) {
