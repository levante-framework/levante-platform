...
.jspsych-display-element p:not(.stimulus, .feedback) {
  text-align: center;
...
.jspsych-display-element .column_2_lower img {
  max-width: 100%;
}
...
.jspsych-display-element .charactercenter {
  height: 40vh;
}
...
.jspsych-display-element .adventure_mid_break {
  position: relative;
  display: inline-flex;
  flex-direction: row;
  height: 30vh;
...
.jspsych-display-element .coin {
  position: relative;
  height: 15vh;
  margin: 10vh;
}
.jspsych-display-element .cues {
  position: relative;
  top: 5vh;
  margin: 10vh;
  height: 15vh;
}
.jspsych-display-element .coin_feedback {
  position: relative;
  width: 20vh;
}
.jspsych-display-element .wizard {
  position: relative;
  height: 30vh;
...
.jspsych-display-element .guardian {
  position: relative;
  height: 30vh;
  bottom: 4vh;
  display: inline-flex;
}
.jspsych-display-element #gate {
  height: 40vh;
  left: 50vh;
  display: inline-flex;
}
.jspsych-display-element .normal_center_text {
  text-align: center;
  position: relative;
  top: 50%;
}
.jspsych-display-element .key {
  vertical-align: middle;
  text-align: center;
  position: relative;
  top: 600px;
...
.jspsych-display-element .btn-arrows {
  height: 18vh;
}
...
.jspsych-display-element .lexicality-trial-arrows {
  background-color: transparent;
  border: transparent;
  padding: 0;
}
.jspsych-display-element .countdown-arrows {
  background-color: transparent;
  border: transparent;
  margin-left: 5rem;
  margin-right: 5rem;
}
.jspsych-display-element #countdown-wrapper {
  position: absolute;
  bottom: 20%;
  width: 100%;
}
.jspsych-display-element #countdown-arrows-wrapper {
  display: flex;
  justify-content: center;
}
.jspsych-display-element .languageForm {
  display: flex;
  justify-content: center;
  align-items: center;
