...
class RoarAppkit {
    ...
    updateUser(_a) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.user.updateUser(Object.assign({ tasks,
                variants,
                assessmentPid }, userMetadata));
        });
    }
    /**
            ...
            if (this._started) {
                ...
                return this.task.updateTaskParams(newParams)
                    ...
                    return (0, firestore_1.updateDoc)(this.user.userRef, {
                        variants: (0, firestore_1.arrayRemove)(oldVariantId),
                    });
                })
                    .then(() => {
                    return (0, firestore_1.updateDoc)(this.user.userRef, {
                    ...
                    .then(() => {
                    return (0, firestore_1.updateDoc)(this.run.runRef, {
