...
function D(t2, e, o = true) {
  var n, r, i2, l;
  if (t2) {
    let d = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), s4 = d.height, a2 = d.width, u = e.offsetHeight, c = e.offsetWidth, f2 = e.getBoundingClientRect(), g3 = $(), it = k(), lt = h(), L, N2, ot = "top";
...
function I(t2, e, o = true, n = void 0) {
  var r;
  if (t2) {
    let i2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), l = e.offsetHeight, d = e.getBoundingClientRect(), s4 = h(), a2, u, c = n != null ? n : "top";
...
function Dt2(e = {}, t2) {
  if (p(t2)) {
    let r = t2.trim();
    return z(r, k2) ? r.replaceAll(k2, (s4) => F(e, s4.replace(/{|}/g, ""))) : r;
...
var D2 = (e, t2, r) => {
  e = Te(e), t2 = Te(t2);
  let a2 = (r / 100 * 2 - 1 + 1) / 2, n = 1 - a2, l = Ne(e), o = Ne(t2), c = Math.round(l.r * a2 + o.r * n), m2 = Math.round(l.g * a2 + o.g * n), d = Math.round(l.b * a2 + o.b * n);
  return ht2(c, m2, d);
};
...
var w3 = (e = {}) => {
  ...
  return { preset(s4) {
    ...
    let { semantic: i2 } = t2 || {};
    return t2 = $2(g2({}, t2), { semantic: $2(g2({}, i2), { primary: s4 }) }), this;
  }, surfacePalette(s4) {
    var o, c;
    let { semantic: i2 } = t2 || {}, a2 = s4 && Object.hasOwn(s4, "light") ? s4.light : s4, n = s4 && Object.hasOwn(s4, "dark") ? s4.dark : s4, l = { colorScheme: { light: g2(g2({}, (o = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : o.light), !!a2 && { surface: a2 }), dark: g2(g2({}, (c = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : c.dark), !!n && { surface: n }) } };
    return t2 = $2(g2({}, t2), { semantic: g2(g2({}, i2), l) }), this;
    ...
    let a2 = { preset: s4 ? U(S2.getPreset(), t2) : t2, options: i2 ? g2(g2({}, S2.getOptions()), r) : r };
...
var he = class {
  ...
  add(t2, r) {
    if (s(r)) {
      ...
      this._styles.set(t2, $2(g2({}, s4), { element: this.createStyleElement(s4) }));
    }
  }
  update() {
  }
...
//# sourceMappingURL=chunk-KBJJZHP7.js.map
