var jsPsychHtmlSwipeResponse = (function (jspsych) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    class HtmlSwipeResponsePlugin {
        ...
        trial(display_element, trial) {
            // display stimulus
            let html = '<div id="jspsych-html-swipe-response-stimulus-container"><div id="jspsych-html-swipe-response-stimulus">' +
                trial.stimulus +
                "</div></div>";
            //display buttons
            var buttons = [];
            if (Array.isArray(trial.button_html)) {
                if (trial.button_html.length == trial.button_choices.length) {
                    ...
                    console.error("Error in html-swipe-response plugin. The length of the button_html array does not equal the length of the button_choices array");
                }
            }
            else {
            ...
            const resetPosition = () => __awaiter(this, void 0, void 0, function* () {
                for (const div of [container_div, stimulus_div]) {
                    div.style.transition = `${trial.swipe_animation_duration / 1000}s ease-in-out, ${trial.swipe_animation_duration / 1000}s ease-in`;
                }
            ...
            const after_keyboard_response = (info) => {
                ...
                if (response.key == null) {
                    response = Object.assign({ source: "keyboard", button: null, swipe: null }, info);
                }
    ...
    return HtmlSwipeResponsePlugin;

})(jsPsychModule);
//# sourceMappingURL=https://unpkg.com/@jspsych-contrib/plugin-html-swipe-response@1.1.3/dist/index.browser.js.map
