...
export declare const initializeFirebaseProject: (config: FirebaseConfig, name: string, emulatorConfig?: Emulators | undefined, authPersistence?: AuthPersistence, markRawConfig?: MarkRawConfig) => Promise<{
