...
export declare class RoarTaskVariant {
     ...
     */
    constructor({ db, taskId, taskName, taskDescription, taskImage, taskURL, taskVersion, external, variantName, variantDescription, variantParams, testData, demoData, }: TaskVariantInput);
    /**
